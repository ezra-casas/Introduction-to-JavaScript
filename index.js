...
const letter = "1999";
const numLetter = parseInt(letter);
...
function annoyingSong(value){

  for (value; value > 0; value--){
    return `${value} bottles of soda on the wall, ${value} bottles of soda, take one down pass it around ${value - 1} bottles of soda on the wall`
  }
}
